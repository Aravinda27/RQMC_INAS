...
def parse_args():
    ...
    parser.add_argument('--checkpointdir', type=str, help='output base dir',
                       default='/mnt/new_volume/Aravinda_data/codes/QMC_BMNAS_github/')
    parser.add_argument('--datadir', type=str, help='data directory',
                        default='/mnt/new_volume/Aravinda_data/codes/QMC_BMNAS_github/BM-NAS_dataset/NTU')
    ...
    parser.add_argument('--num_input_nodes', type=int, help='cell input', default=4)
    ...
    parser.add_argument('--device',type=str,help='CUDA devices',default='cuda')
